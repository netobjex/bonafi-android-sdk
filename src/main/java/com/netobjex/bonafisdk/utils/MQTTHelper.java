package com.netobjex.bonafisdk.utils;
...
public class MQTTHelper {
    ...
    public MQTTHelper(Context context, String mqttServerUrl, String mqttUsername, String mqttPassword){
        ...
        mqttAndroidClient = new MqttAndroidClient(context, serverUri, UUID.randomUUID().toString());
    ...
    private void subscribeToTopic() {
        String subscriptionTopic = "/topic/device/nfctag/in";
        try {
